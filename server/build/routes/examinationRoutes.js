...
var transporter = _nodemailer2.default.createTransport(config.email.host, {
  debug: true
});
...
exports.queryExam = function (Examination, User) {
  return function (req, res, next) {
    ...
    Examination.findOne({ _id: req.body.examId }).exec().then(function (exam) {
      ...
      return User.findOne({ _id: exam.userId }).exec().then(function (user) {
...
//# sourceMappingURL=examinationRoutes.js.map